  ...
  return (
    <form className="authForm">
      ...
      <div className="form-floating mb-3 authFormInputs">
        ...
        <label htmlFor="floatingEmail">Email address</label> {/* Corrected htmlFor */}
      </div>
      <div className="form-floating mb-3 authFormInputs">
...
Register.propTypes = {
  setIsLoginBox: PropTypes.func.isRequired, // Define setIsLoginBox as a required function prop
};
